            ...
            <tbody>
              {specs.map((spec, index) => (
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-6 text-gray-800 font-medium" colSpan="2">
                    {spec.value}
                  </td>
                </tr>
              ))}
              ...
              <tr className="border-b border-gray-200">
                <td className="py-4 px-6 bg-gray-50 font-medium text-gray-700 border-r border-gray-200 w-1/3" rowSpan={moduleSpecs.length}>
                  Module
                </td>
              ...
              <tr className="border-b border-gray-200">
                <td className="py-4 px-6 bg-gray-50 font-medium text-gray-700 border-r border-gray-200 w-1/3" rowSpan={cabinetSpecs.length}>
                  Cabinet
                </td>
                <td className="py-4 px-6 text-gray-600 border-r border-gray-200">
              ...
              {cabinetSpecs.slice(1).map((spec, index) => (
                <tr key={index} className={index === cabinetSpecs.length - 2 ? "" : "border-b border-gray-200"}>
                  <td className="py-4 px-6 text-gray-600 border-r border-gray-200">
                    {spec.label}
                  </td>
                  <td className="py-4 px-6 text-gray-800 font-medium">
