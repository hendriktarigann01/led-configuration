    ...
    <BasePage>
      ...
      <div className="px-16 py-20">
        <div className="text-center mb-10 mt-20">
          <h2 className="text-2xl text-[24px] text-gray-700 flex items-center justify-center space-x-4">
            ...
            <span className="font-medium text-lg leading-none flex items-center">
              Specification
            </span>
            <div className="flex space-x-1">
              <div className="w-2 h-2 bg-[#E0F2F0] rounded-full"></div>
      ...
      <div className="absolute bottom-6 left-8 text-[10px] space-y-2 text-gray-600">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-1">
            ...
            <span className="leading-none">mjsolution.co.id</span>
          </div>
          <div className="flex items-center space-x-1">
            <img src="/icons/icon-call.svg" className="w-4 h-4" alt="call" />
            <span className="leading-none">(+62) 811-1122-492</span>
          </div>
        </div>
      </div>
    </BasePage>
